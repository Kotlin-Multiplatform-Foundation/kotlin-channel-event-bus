...
@Immutable
@Parcelize
data object RegisterStepTwoScreenRoute : NavRoute

@JvmField
val RegisterStepTwoScreenDestination: NavDestination =
  ScreenDestination<RegisterStepTwoScreenRoute> { route, modifier ->
